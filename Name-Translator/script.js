...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeTheme() {
        const savedTheme = localStorage.getItem('pharaoh-theme') || 'dark';
    ...
    function applyTheme(theme) {
        ...
        localStorage.setItem('pharaoh-theme', theme);
    ...
    // ============================================
    // MOBILE MENU TOGGLE
const openMenuBtn = document.getElementById('menuBtn'); // زرار فتح المنيو
const closeMenuBtn = document.getElementById('closeBtn'); // زرار قفل المنيو
const mobileMenu = document.getElementById('mobileMenu');
const menuOverlay = document.getElementById('menuOverlay');
const mobileMenuLinks = document.querySelectorAll('.menu-link'); // كل لينكات المنيو
...
// لما تدوس على أي لينك، المنيو تقفل
