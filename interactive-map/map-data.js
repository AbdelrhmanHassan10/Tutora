const MAP_DATA = {
    ...
    complex: [
        ...
        { id: "hanging-obelisk-ext", name: "Hanging Obelisk", nameAr: "المسلة المعلقة", type: "poi", labelId: 1, description: "The world's first hanging obelisk, showcasing the cartouche of Ramses II on its base.", descriptionAr: "أول مسلة معلقة في العالم، تظهر خرطوشة رمسيس الثاني على قاعدتها.", image: "../the-entrance-to-the-grand-egyptian-museum-3BAN3ER.jpg", coordinates: { x: 400, y: 700 } },
        { id: "events-area", name: "Events Area", nameAr: "منطقة الفعاليات", type: "area", labelId: 2, description: "Outdoor venue for cultural events and exhibitions with views of the Giza Pyramids.", descriptionAr: "مكان خارجي للفعاليات الثقافية والمعارض مع إطلالة على أهرامات الجيزة.", image: "../the-grand-egyptian-museum-fully-opens-completing-gizas-new-cultural-landmark_8.jpg", coordinates: { x: 750, y: 650 } },
        { id: "khufu-boats-ext", name: "Khufu's Boats Museum", nameAr: "متحف مراكب خوفو", type: "building", labelId: 3, description: "Dedicated museum for the ancient solar barks of King Khufu.", descriptionAr: "متحف مخصص لمراكب الشمس القديمة للملك خوفو.", image: "../the-grand-egyptian-museum-fully-opens-completing-gizas-new-cultural-landmark_7.jpg", coordinates: { x: 650, y: 400 } },
        { id: "pyramid-steps", name: "Pyramid Steps", nameAr: "سلالم الأهرامات", type: "poi", labelId: 4, description: "A unique architectural viewpoint overlooking the Giza plateau.", descriptionAr: "نقطة مراقبة معمارية فريدة تطل على هضبة الجيزة.", image: "../Grand_Staircase_(GEM).jpg", coordinates: { x: 400, y: 350 } },
        { id: "conservation-centre-ext", name: "Conservation Centre", nameAr: "مركز الترميم", type: "building", labelId: 5, description: "Advanced laboratories for the restoration and preservation of Egypt's artifacts.", descriptionAr: "مختبرات متقدمة لترميم والحفاظ على آثار مصر.", image: "../tutora-lab.png", coordinates: { x: 500, y: 150 } },
        { id: "sculpture-garden", name: "Sculpture Garden", nameAr: "حديقة المنحوتات", type: "garden", description: "Open-air gallery featuring monumental statues from various eras of Egyptian history.", descriptionAr: "معرض مفتوح يعرض تماثيل ضخمة من عصور مختلفة من التاريخ المصري.", image: "../the-grand-egyptian-museum-fully-opens-completing-gizas-new-cultural-landmark_4.jpg", coordinates: { x: 250, y: 650 } },
        { id: "terraced-garden", name: "Terraced Garden", nameAr: "الحديقة المدرجة", type: "garden", description: "Beautifully landscaped gardens offering a peaceful environment for visitors.", descriptionAr: "حدائق ذات مناظر طبيعية جميلة توفر بيئة هادئة للزوار.", image: "../the-grand-egyptian-museum-fully-opens-completing-gizas-new-cultural-landmark_5.jpg", coordinates: { x: 550, y: 350 } },
        { id: "palm-garden", name: "Palm Garden", nameAr: "حديقة النخيل", type: "garden", description: "Lush palm groves representing the fertile lands of the Nile valley.", descriptionAr: "بساتين النخيل المورقة تمثل الأراضي الخصبة لوادي النيل.", image: "../the-grand-egyptian-museum-fully-opens-completing-gizas-new-cultural-landmark_6.jpg", coordinates: { x: 700, y: 750 } },
        { id: "parking-main", name: "Main Parking", nameAr: "موقف السيارات الرئيسي", type: "parking", description: "Primary visitor parking area with easy access to the ticketing entrance.", descriptionAr: "منطقة مواقف الزوار الرئيسية مع وصول سهل لمدخل التذاكر.", image: "../parking.png", coordinates: { x: 150, y: 800 } }
    ],
    pois: [
