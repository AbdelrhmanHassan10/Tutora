...
const regex = /\/\* ============================================\s*GLOBAL NAVBAR MOBILE SPACING OPTIMIZATION[\s\S]*?\/\* ==========================================================================\s*STANDARDIZED PREMIUM FOOTER LOGO RINGS & THEME ADAPTATIONS\s*========================================================================== \*\//g;
...
const newCss = css.replace(regex, replacement);
